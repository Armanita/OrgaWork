...
const ids = {
  ...
  sourceResponsibility: '55555555-5555-4555-8555-555555555555',
...
function pendingPrimary() {
  return createActionItem({
    ...
    sourceResponsibilityId: ids.sourceResponsibility,
    responsible: {
      kind: 'membership',
...
describe('action item contract v2', () => {
  it('creates a normalized primary action with independent responsibility', () => {
    ...
    expect(value.sourceResponsibilityId).toBe(ids.sourceResponsibility);
