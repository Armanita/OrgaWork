...
export interface ActionItem {
  ...
  readonly caseId: CaseId;
  readonly organizationId: OrganizationId;
  readonly sourceResponsibilityId: CaseResponsibilityId | null;
...
export function createActionItem(input: {
  ...
  readonly sourceResponsibilityId?: string;
  ...
  return {
    ...
    sourceResponsibilityId:
      input.sourceResponsibilityId === undefined
        ? null
        : createCaseResponsibilityId(input.sourceResponsibilityId),
