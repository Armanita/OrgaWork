...
- زیرمرحله بسته‌شده: `P1.4.2 — تعریف فایل‌های محیط محلی و مقادیر نمونه امن`
- زیرمرحله جاری: `P1.4.3 — راه‌اندازی PostgreSQL 16 با نسخه ثابت`
- شواهد مرحله: `EVD-009` و `EVD-010`
- ریسک `RISK-003`: بسته‌شده
- فرض `ASM-001`: ردشده؛ Docker در دسترس نیست
- ادعای پیاده‌سازی فعلی: هیچ سرویس Containerشده‌ای هنوز ایجاد نشده است
