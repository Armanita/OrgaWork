...
- وابستگی یا تصمیم مهم: P1.4.1 ممیزی فقط‌خواندنی Docker
...
شواهد فنی اولیه ثبت شده‌اند، اما Commit و Tag پذیرش هنوز شکاف باز هستند.

## 129. پوشش مراحل آینده

P1.4 تا P12 در سطح نیاز، مالک و معیار هدف ردیابی شده‌اند، نه در سطح ادعای پیاده‌سازی.
