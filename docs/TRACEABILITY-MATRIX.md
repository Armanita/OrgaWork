...
- زیرمرحله بسته‌شده: `P1.5.3 — ثبت تاریخچه، ترتیب و اثرانگشت مهاجرت‌ها`
- مرحله بسته‌شده: `P1.5 — مهاجرت پایگاه داده و جداسازی سازمانی`
- آخرین زیرمرحله بسته‌شده: `P1.5.14 — آزمون و پذیرش مرحله`
- مرحله بسته‌شده: `P1.6 — قراردادهای مشترک و OpenAPI`
- آخرین زیرمرحله بسته‌شده: `P1.6.12 — آزمون و پذیرش مرحله`
- زیرمرحله جاری: `P1.7.1 — تعریف ثبت رخداد ساختاریافته مشترک`
- شواهد مرحله: `EVD-025`
- شواهد مرحله: `EVD-024`
- شواهد مرحله: `EVD-023`
- شواهد مرحله: `EVD-022`
