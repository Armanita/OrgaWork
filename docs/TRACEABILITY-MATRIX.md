...
`P1` با شاهد `EVD-030` بسته شده است. `P2.1` با شاهد `EVD-031` بسته و `P2.2` مرحله جاری است.

`P2.2` تا `P12` فقط در سطح نیاز، مالک و معیار هدف ردیابی شده‌اند، مگر آنکه شاهد مستقل ثبت شده باشد.
